// Copied response for testing from the REST endpoint, made modification to test
// sorting.
...
const howItWorksResponse = [
  ...
  {
    id: "d9a439d0-8dbf-4bab-8e08-744992344b823",
    stepNumber: "10",
    versionContent: [
      {
        title: "Fill Out Another Profile",
        body:
          "We only want you to get games and gear that you’ll love, so we’ll ask for your preferences at the end.",
        effectiveDate: "2019-05-20T03:04:05.000Z"
      }
    ]
  }
...
export default howItWorksResponse;
